...
function MenuOverlay({ navigateTo, menuList, setToggle}) {
  return (
    ...
    via-[#120B2E] to-[black]  backdrop-blur-lg w-full mt-7'>
        {menuList.map((item, index)=> (
            <h1 key={index} onClick={() => { navigateTo(item.view) || item.title; setToggle(false); }} className='text-white text-[24px] mb-6 justify-center mt-10
